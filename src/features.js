...
function featureOverlaysBase(features) {
  ...
  if (ids.includes('iron_plates')||ids.includes('exoskeleton')||ids.includes('hybrid_ironscale')||ids.includes('hybrid_flameirn')) { const ic=ids.includes('hybrid_flameirn')?'#e06030':'#ce422b'; out.push(`<polygon points="38,38 42,38 40,31" fill="${ic}cc" stroke="${ic}" stroke-width="0.7" stroke-linejoin="round"/><polygon points="43,36 47,36 45,26" fill="${ic}cc" stroke="${ic}" stroke-width="0.7" stroke-linejoin="round"/><polygon points="47.5,35 52.5,35 50,22" fill="${ic}cc" stroke="${ic}" stroke-width="0.8" stroke-linejoin="round"/><polygon points="53,36 57,36 55,26" fill="${ic}cc" stroke="${ic}" stroke-width="0.7" stroke-linejoin="round"/><polygon points="58,38 62,38 60,31" fill="${ic}cc" stroke="${ic}" stroke-width="0.7" stroke-linejoin="round"/><polygon points="42,62 46,57 50,62 46,67" fill="${ic}25" stroke="${ic}" stroke-width="0.8"/><polygon points="50,62 54,57 58,62 54,67" fill="${ic}25" stroke="${ic}" stroke-width="0.8"/><polygon points="46,73 50,68 54,73 50,78" fill="${ic}25" stroke="${ic}" stroke-width="0.8"/>`); }
  if (ids.includes('rust_flecks')) out.push(`<g opacity="0.56"><circle cx="43.5" cy="46.8" r="0.55" fill="#7a3424"/><circle cx="48.2" cy="45.6" r="0.42" fill="#a24a2c"/><circle cx="53.8" cy="46.9" r="0.48" fill="#7a3424"/><circle cx="58.4" cy="49.2" r="0.4" fill="#cb6a3a"/><circle cx="41.7" cy="52.9" r="0.46" fill="#a24a2c"/><circle cx="46.3" cy="54.4" r="0.38" fill="#7a3424"/><circle cx="52.7" cy="53.2" r="0.5" fill="#a24a2c"/><circle cx="57.1" cy="55.3" r="0.43" fill="#7a3424"/><circle cx="44.6" cy="60.7" r="0.47" fill="#7a3424"/><circle cx="49.9" cy="61.8" r="0.56" fill="#a24a2c"/><circle cx="55.0" cy="60.9" r="0.44" fill="#7a3424"/><circle cx="47.2" cy="67.0" r="0.46" fill="#a24a2c"/><circle cx="52.3" cy="67.6" r="0.39" fill="#7a3424"/></g>`);
  ...
  if (ids.includes('lightning_fin')||ids.includes('hybrid_voidarc')||ids.includes('hybrid_scale_spark')) { const fc=ids.includes('hybrid_voidarc')?'#9b72cf':'#f7df1e'; out.push(`<polygon points="50,16 44,28 48,26 43,40 50,34 57,40 52,26 56,28" fill="${fc}77" stroke="${fc}" stroke-width="0.8"/>`); }
  if (ids.includes('arc_trail')) out.push(`<g opacity="0.65"><path d="M22,32 L18,22 L21,28" fill="none" stroke="#f7df1e" stroke-width="0.9" stroke-linecap="round"/><path d="M78,32 L82,22 L79,28" fill="none" stroke="#f7df1e" stroke-width="0.9" stroke-linecap="round"/><path d="M50,16 L50,8 L48,14" fill="none" stroke="#f7df1e" stroke-width="0.9" stroke-linecap="round"/><path d="M22,68 L18,78 L21,72" fill="none" stroke="#f7df1e" stroke-width="0.9" stroke-linecap="round"/><path d="M78,68 L82,78 L79,72" fill="none" stroke="#f7df1e" stroke-width="0.9" stroke-linecap="round"/></g>`);
  ...
  if (ids.includes('category_wings')||ids.includes('interface_wings')) { const wc=ids.includes('category_wings')?'#5e5086':'#3178c6'; out.push(`<path class="wing-left wing-upper" d="M28,50 Q14,40 16,26 Q20,14 30,24" fill="${wc}22" stroke="${wc}" stroke-width="0.8"/><path class="wing-right wing-upper" d="M72,50 Q86,40 84,26 Q80,14 70,24" fill="${wc}22" stroke="${wc}" stroke-width="0.8"/>`); }
...
module.exports = { featureOverlays };